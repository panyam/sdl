...
type Metric struct {
	...
	AggregationWindow string `protobuf:"bytes,11,opt,name=aggregation_window,json=aggregationWindow,proto3" json:"aggregation_window,omitempty"`
...
func (x *Metric) GetAggregationWindow() string {
	if x != nil {
...
var file_sdl_v1_models_proto_rawDesc = string([]byte{
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74,
