...
const EstimatesSection = () => {
  ...
  <h2>Step 5 - Estimates and Parameters</h2>
    Before addressing scalability of a system, a system's limits, usage and capacity estimates are in order.   In this section let us tlak about the key estimates of "output" parameters around Storage, Network Bandwidth, IO and their constraints.
