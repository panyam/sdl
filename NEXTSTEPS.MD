...
- [ ] WASM DevEnvPresenter wrapping DevEnv (replaces CanvasViewPresenter)
- [ ] CLI commands migrated to DevEnv API
- [ ] TypeScript DevEnvPage implementation for browser panels
- [ ] Canvas and CanvasViewPresenter deprecated
