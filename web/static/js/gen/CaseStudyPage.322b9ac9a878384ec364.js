(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["notation"] = root["notation"] || {}, root["notation"]["CaseStudyPage"] = factory();
})(this, () => {
return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
/******/ 	var __webpack_modules__ = ({

/***/ "./templates/CaseStudyPage.ts":
/*!************************************!*\
  !*** ./templates/CaseStudyPage.ts ***!
  \************************************/
...
/* harmony export */   ExcalidrawToolbar: () => (/* reexport safe */ _ExcalidrawWrapper__WEBPACK_IMPORTED_MODULE_0__.ExcalidrawToolbar),
/* harmony export */   ExcalidrawWrapper: () => (/* reexport safe */ _ExcalidrawWrapper__WEBPACK_IMPORTED_MODULE_0__.ExcalidrawWrapper)
/* harmony export */ });
/* harmony import */ var _ExcalidrawWrapper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ExcalidrawWrapper */ "./templates/ExcalidrawWrapper.ts");
/* harmony import */ var split_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! split.js */ "./node_modules/.pnpm/split.js@1.6.5/node_modules/split.js/dist/split.es.js");



window.ExcalidrawWrapper = _ExcalidrawWrapper__WEBPACK_IMPORTED_MODULE_0__.ExcalidrawWrapper;
class SystemDrawing {
    constructor(caseStudyId, container, toolbarContainer) {
        this.caseStudyId = caseStudyId;
        this.container = container;
        this.toolbarContainer = toolbarContainer;
        this.excalWrapper = new _ExcalidrawWrapper__WEBPACK_IMPORTED_MODULE_0__.ExcalidrawWrapper(container, {
            uiOptions: {}
        });
        if (toolbarContainer) {
            this.excalToolbar = new _ExcalidrawWrapper__WEBPACK_IMPORTED_MODULE_0__.ExcalidrawToolbar(toolbarContainer, {
                vertical: true,
...
class CaseStudyPage {
    constructor() {
        this.caseStudyId = document.getElementById("caseStudyId").value;
        const drawings = document.querySelectorAll(".systemDrawing");
        for (const drawing of drawings) {
            const rootElem = drawing;
            const tbElem = rootElem.querySelector("toolbar");
            const sd = new SystemDrawing(this.caseStudyId, rootElem, tbElem);
        }
        (0,split_js__WEBPACK_IMPORTED_MODULE_1__["default"])(["#outlinePanel", "#contentPanel", "#notesPanel"], { sizes: [15, 70], direction: "horizontal", });
    }
}
...
/***/ "./templates/ExcalidrawWrapper.ts":
/*!****************************************!*\
  !*** ./templates/ExcalidrawWrapper.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ExcalidrawToolbar: () => (/* binding */ ExcalidrawToolbar),
/* harmony export */   ExcalidrawWrapper: () => (/* binding */ ExcalidrawWrapper)
/* harmony export */ });
/* harmony import */ var _excalidraw_excalidraw__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @excalidraw/excalidraw */ "./node_modules/.pnpm/@excalidraw+excalidraw@0.17.6_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@excalidraw/excalidraw/main.js");
        ...
        this.addButton({
            ...
            onClick: () => __awaiter(this, void 0, void 0, function* () {
                if (this.excalidrawWrapper) {
                    ...
                    if (drawingId) {
                        try {
                            const response = yield fetch(`/drawings/${drawingId}/`, {
                                method: 'POST',
                                headers: {
                ...
                if (this.excalidrawWrapper) {
                    ...
                    fileInput.addEventListener("change", (e) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (target.files && target.files[0] && this.excalidrawWrapper) {
                            ...
                            yield this.excalidrawWrapper.loadFromBlob(file);
                        }
...
class ExcalidrawWrapper {
    constructor(container, options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.uiOptions) {
        ...
        const initialData = (options === null || options === void 0 ? void 0 : options.initialData) || preElementData;
    ...
    initialize() {
        return __awaiter(this, arguments, void 0, function* (initialData = null) {
            try {
                ...
                const excalidrawModule = yield Promise.resolve(/*! import() */).then(__webpack_require__.t.bind(__webpack_require__, /*! @excalidraw/excalidraw */ "./node_modules/.pnpm/@excalidraw+excalidraw@0.17.6_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@excalidraw/excalidraw/main.js", 23));
                const React = yield Promise.resolve(/*! import() */).then(__webpack_require__.t.bind(__webpack_require__, /*! react */ "./node_modules/.pnpm/react@18.3.1/node_modules/react/index.js", 23));
                const ReactDOM = yield Promise.resolve(/*! import() */).then(__webpack_require__.t.bind(__webpack_require__, /*! react-dom */ "./node_modules/.pnpm/react-dom@18.3.1_react@18.3.1/node_modules/react-dom/index.js", 19));
                ...
                const self = this;
                ReactDOM.render(React.createElement(ExcalidrawComponent, {
                    onChange: (elements, appState) => {
    ...
    loadFromJSON(jsonData) {
        try {
            ...
            this.excalidrawInstance.updateScene({
                elements: (0,_excalidraw_excalidraw__WEBPACK_IMPORTED_MODULE_0__.convertToExcalidrawElements)(elements),
    ...
    loadFromBlob(blob) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { elements, appState, files } = yield (0,_excalidraw_excalidraw__WEBPACK_IMPORTED_MODULE_0__.loadFromBlob)(blob, null, null);
                this.excalidrawInstance.updateScene({
                    elements: elements || [],
                    appState: appState || {}
                });
    ...
    exportToBlob() {
        return __awaiter(this, arguments, void 0, function* (mimeType = "image/png") {
            if (!this.excalidrawInstance) {
                throw new Error("Excalidraw instance not initialized");
            }
            return (0,_excalidraw_excalidraw__WEBPACK_IMPORTED_MODULE_0__.exportToBlob)({
    ...
    getAsJSON() {
        ...
        return (0,_excalidraw_excalidraw__WEBPACK_IMPORTED_MODULE_0__.serializeAsJSON)(this.elements, this.appState, {}, "local");
    }
    setTheme(theme) {
        if (!this.excalidrawInstance) {
            console.error("Excalidraw instance not initialized");
        ...
        this.appState = Object.assign(Object.assign({}, this.appState), { theme });
        this.excalidrawInstance.updateScene({
            elements: this.elements,
            appState: { theme }
        });
    ...
    setReadOnly(readOnly) {
        ...
        this.appState = Object.assign(Object.assign({}, this.appState), { viewModeEnabled: readOnly });
        this.excalidrawInstance.updateScene({
            elements: this.elements,
    ...
    setUIOptions(options) {
        ...
        if (this.excalidrawInstance) {
            this.excalidrawInstance.updateScene({
                appState: Object.assign(Object.assign({}, this.appState), { openSidebar: this.uiOptions.defaultSidebarOpen ? { name: 'library' } : null })
            });
        }
    }
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("CaseStudyPage." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
/******/ 	/* webpack/runtime/getFullHash */
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("bd14a8e26299d44d6a8e")
/******/ 	})();
/******/ 	
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = this["webpackChunknotation"] = this["webpackChunknotation"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_pnpm_excalidraw_excalidraw_0_17_6_react-dom_18_3_1_react_18_3_1__react_1-9ed7fd"], () => (__webpack_require__("./templates/CaseStudyPage.ts")))
...
//# sourceMappingURL=CaseStudyPage.322b9ac9a878384ec364.js.map