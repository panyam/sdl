...
export const CanvasService: GenService<{
   ...
   * Create a new canvas sesssion.
   *
   * @generated from rpc sdl.v1.CanvasService.UpdateCanvas
   */
  updateCanvas: {
    methodKind: "unary";
