...
import { CanvasService } from "../gen/sdl/v1/services/canvas_pb.ts"
import { GeneratorSchema, MetricSchema, CanvasSchema } from "../gen/sdl/v1/models/models_pb.ts";
import type { Generator, Metric, Canvas } from "../gen/sdl/v1/models/models_pb.ts";
